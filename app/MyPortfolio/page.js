        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {projects.map((project, index) => (
            <div
              ...
              className="group relative bg-slate-900/50 backdrop-blur-xl rounded-[2rem] overflow-hidden border border-white/10 hover:border-blue-500/50 transition-all duration-500 flex flex-col shadow-2xl hover:shadow-blue-500/10 animate-in fade-in zoom-in duration-700"
            >
