...
const Contact = () => {
  ...
  return (
    <section
      className="min-h-screen  py-28 px-6 relative overflow-hidden text-white"
      id="contact"
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col items-center text-center mb-20">
          ...
          >
            Ready to{" "}
            <span className="text-outline-thin text-transparent">
              Collaborate?
            </span>
          </motion.h2>

          <p className="max-w-xl text-slate-400 font-light text-lg italic">
            Want to discuss a new project? I'm just a message away!{" "}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            <h3 className="text-xs font-black uppercase tracking-[0.5em] text-slate-500 mb-6 ml-2 italic">
              Connect via
            </h3>
            ...
            <div className="p-10 rounded-[2.5rem] bg-white/[0.02] border border-white/5 backdrop-blur-3xl relative overflow-hidden group mt-10">
              <div className="flex justify-between items-start mb-6">
                ...
                <span className="px-3 py-1 bg-cyan-500 text-black text-[8px] font-black rounded-full uppercase">
                  Active Now
                </span>
              </div>
              ...
              <p className="text-slate-500 font-mono text-[10px] tracking-widest uppercase mt-2">
                Available: 10 AM - 12 PM
              </p>
            </div>
          </div>
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col gap-3 text-left">
                <label className="text-[10px] uppercase tracking-[0.4em] font-black text-slate-500 ml-4 italic">
                  Message Details
                </label>
                <textarea
                  rows="4"
  ...
  return (
    ...
    >
      <div className="flex items-center gap-6 text-left">
        <div
          className={`w-14 h-14 bg-white/5 rounded-2xl flex items-center justify-center text-2xl border border-white/10 transition-colors ${color}`}
        >
          {icon}
        </div>
        <div>
          <p className="text-[9px] uppercase tracking-widest text-slate-500 font-black mb-1 italic">
            {title}
          </p>
          <p className="text-lg font-bold italic text-slate-200 tracking-tight">
            {value}
          </p>
        </div>
      </div>
